		...
		<IonPage>
			...
			<IonContent>
				...
				<div className="flex flex-col gap-2 p-2 justify-center items-center space-y-4">
					{!elementClicked ? (
						<div
							className="shadow-md  border-t border-t-blue-900 shadow-black p-8 rounded w-80 md:w-150 cursor-pointer"
							onClick={handleClick}
						>
							<div className="flex justify-between items-center">
								<IonIcon icon={businessOutline} size="large" />
								<p className="font-semibold text-xl md:text-2xl">Experience</p>
								<p className="font-semibold bg-[#0c0c61] rounded-full p-2 md:text-xl">
									6 Months
								</p>
							</div>
						</div>
						...
						<div
							className=" p-8 rounded w-80 h-80 md:w-150 cursor-pointer overflow-auto"
							onClick={handleClick}
						>
							<div className="flex justify-between items-center">
								<IonIcon icon={businessOutline} size="large" />
